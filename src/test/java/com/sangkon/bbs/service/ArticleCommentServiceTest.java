...
class ArticleCommentServiceTest {
    ...
    void givenArticleId_whenSearchingArticleComments_thenReturnsArticleComments() {
        ...
        assertThat(actual).extracting("id", "articleId", "parentCommentId", "content").containsExactlyInAnyOrder(tuple(1L, 1L, null, "parent content"), tuple(2L, 1L, 1L, "child content"));
    ...
    private UserAccountDto createUserAccountDto() {
        return UserAccountDto.of("sd", "password", "sd@test.com", "Sd", "Me?", LocalDateTime.now(), "sd", LocalDateTime.now(), "sd");
    }
    ...
    private UserAccount createUserAccount() {
        return UserAccount.of("sd", "password", "sd@test.com", "Sd", null);
    }
