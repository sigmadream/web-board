...
import com.sangkon.bbs.repository.ArticleCommentRepository;
...
class ArticleCommentServiceTest {
    ...
    @DisplayName("게시글 ID를 조회하면, 관련 댓글 목록을 반환한다.")
    @Test
    ...
    @DisplayName("댓글을 작성했지만 게시글이 없으면, 경고 로그를 출력하고 아무것도 안 한다.")
    @Test
